        ...
        <p className="text-6xl w-80 place-self-center	 text-center bg-green-500 font-bold text-white py-1 px-2 rounded dark:text-gray-900">
          ...
          <div className="flex w-full mt-5 hover:shadow focus-within:shadow  max-w-md rounded-full border border-gray-500 md:hover:border-white dark:bg-gray-700 md:dark:hover:border-gray-100 px-5 py-2 sm:py-3 items-center sm:max-w-xl lg:max-w-2xl">
            ...
            <input
              ...
              className="focus:outline-none w-full flex-grow dark:bg-transparent placeholder-gray-500 dark:placeholder-white custom-input"
            />
            
          </div>

          <div className="flex flex-row space-y-0 w-[90%] justify-center  mt-8 space-x-3 sm:space-x-4  ">
            <button type="submit" onClick={search} className="btn bg-[#0EA5E9] rounded-3xl hover:bg-[#3B82F6]	  active:bg-[#2563EB]"	>
            <p className="text-xl font-bold text-black py-1 px-2 rounded    dark:text-gray-900">Search</p>
            </button>
          </div>
        </form>
